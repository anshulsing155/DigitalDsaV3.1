...
<Seo
  type="WebPage"
  title="Regular Contributions Planner — Savings Goal Calculator | DigitalDSA"
  description="Estimate how much you can accumulate over time with regular monthly contributions and compound interest payouts."
  keywords="regular contributions, savings accumulation calculator, systematic planning, compound interest planner"
/>
  ...
  >
    ...
    <div class="space-y-[2rem] w-full px-0 md:px-6 lg:px-12 pt-4">
      <div class="px-2">
        ...
        >
          How Much Can I Save With Regular Contributions?
        </h1>
        <h2 class="font-Paragraph text-minParaFont lg:text-paraFont">
          Plan systematic deposits (like RD or SIP) and see how compounding accelerates your growth. Estimate the total maturity value based on periodic saving intervals.
        </h2>
      </div>
      <div>
        <SaveGoalWithTenure />
