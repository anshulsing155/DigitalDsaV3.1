		...
		<div class="lg:px-16">
			...
			<div id="repayment" class="">
				...
				>
					...
					<Button
						link={content.repaymentsCard.buttonBanner.btnLink}
						btnName={content.repaymentsCard.buttonBanner.btnName}
						btnClass={content.repaymentsCard.buttonBanner.btnClass}
					/>
				</TwoColumn>
			</div>
