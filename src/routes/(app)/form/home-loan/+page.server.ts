/**
 * Home Loan Form — Server Loader
 * ══════════════════════════════════════════════════════════════════
 * Evaluates page 0 of the Home Loan schema with empty answers
 * (initial load). Subsequent page evaluations happen via
...
export const load: PageServerLoad = async ({ locals }) => {
	...
	// Load form engine + ConfirmModal context (quota + in-flight) in parallel.
	// The modal context falls back to nulls on failure — see loadConfirmModalContext.
