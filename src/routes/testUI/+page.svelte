<script lang="ts">
	import Button from '$lib/ui-component/Button.svelte';
	import ThingsYouShould from '$lib/ui-component/ThingsYouShould.svelte';
	import StickyNavbar from '$lib/ui-component/StickyNavbar.svelte';
	import NewPageLayout from '$lib/ui-component/NewPageLayout.svelte';
	import ThreeColumWithLeftHeading from '$lib/ui-component/ThreeColumWithLeftHeading.svelte';
	import AboveTitleWithLeftIconCard from '$lib/ui-component/AboveTitleWithLeftIconCard.svelte';
	import TwoColumnWithImage from '$lib/ui-component/TwoColumnWithImage.svelte';
	import ButtonBanner from '$lib/ui-component/ButtonBanner.svelte';
	import HelpList from '$lib/ui-component/HelpList.svelte';
	import AboveTitleWithBlackCard from '$lib/ui-component/AboveTitleWithBlackCard.svelte';
	import Seo from '$lib/ui-component/Seo.svelte';
	...
	function toggleDropdown(event: MouseEvent, index: number) {
	...
	function initializeActiveSection() {
		...
		if (firstSection) {
			activeSection = (firstSection as HTMLElement).id;
		}
	}
...
<section class="content">
	<NewPageLayout {pageData}>
					...
					actionBtns: [
						{
							btnName: 'Book appointment',
							btnLink: '/appointment',
							btnClass: 'btn-secondary text-[var(--form-text)]'
						},
						{
							btnName: 'Compare rates',
							btnLink: '/get-started/how-can-we-help',
		...
		<TwoColumnWithImage
			contents={{
				cardImage: '/images/first-home-buyer.jpg',
