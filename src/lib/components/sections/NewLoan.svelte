<script>
  ...
  let pageData = {
    ...
    heroHeading: "New loan buyers - Guide to buying your New loan",
    heroParagraph: `Knowing where to start can be the biggest hurdle. The right tools and support will get you moving with confidence.`,
  };
...
window.removeEventListener("scroll", handleScroll);
  ...
  // $effect(() => { console.log("this is newLoan"); });
  // onMount(() => {
  //   setTimeout(() => {
    ...
    <div>
      <div class="hidden lg:block">
        ...
        <div class="px-[2rem] lg:px-[4rem]">
          ...
          <div
            data-section="find"
            id="find"
            class="py-[4rem] flex flex-col gap-2 section"
          >
            {#if forHome.length > 0}
              <h2
                class="md:text-start typography-h2 text-[var(--form-text)]"
      ...
      <div class="lg:hidden block">
        {#each navBarMedium as list, index}
          <details
            class="dropdown col-span-3 bg-[var(--landing-bg-card)] text-[var(--form-text)] {index < navBarMedium.length - 1 ? 'border-b border-[var(--form-border)]' : ''}"
          >
            <summary
            ...
            {:else if index == 1}
              <div
                id="find"
                class="py-[4rem] flex flex-col bg-[var(--landing-bg)] text-[var(--form-text)] px-[0.5rem] pb-4"
              >
                {#if forHome.length > 0}
                  <h2
                    class="md:text-start typography-h2 text-[var(--form-text)]"
            ...
            {:else if index == 2}
              <div id="next" class="bg-[var(--landing-bg)] text-[var(--form-text)] px-[0.5rem] pb-4">
                <TwoColumn
                  cardImage="/images/home-scheme.jpg"
                  cardAltName="parent-figure"
                  cardHeading="Home Guarantee Scheme"
            ...
            {:else if index == 3}
              <div
                id="calculators"
                class="bg-[var(--landing-bg)] text-[var(--form-text)] px-[0.5rem] pb-4"
              >
