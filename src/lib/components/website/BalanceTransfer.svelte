...
<section>
	<NewPageLayout
		pageData={{
			coverImage: '/images/young-indian-couple-planning-loan-refinance-through-DigitalDSA.jpg',
			coverAlt: 'photo of a young indian couple planning balance transfer through DigitalDSA',
			heading: 'Transferring your home loan: When & how to do',
			sourceName: 'Freepik',
			originalSource: 'https://www.freepik.com/free-photo/lovely-couple-looking-laptop_5123228.htm',
			actionBtns: [
				{
		...
		<div class="hidden lg:block">
			...
			<div id="whyRefinance" data-section="whyRefinance" class="section">
                ...
                <span class="font-semibold">💡Example:</span>`,
							...
							{
								heading: 'If you need additional funds for renovation or other needs​',
				...
				<AboveTitleWithTopIconCard
					contents={{
						...
						list: [
							...
							{
								heading: 'If Your Loan Is Fixed-Rate & Prepayment Charges Are High​',
			...
			<div id="how" data-section="how" class="section">
				...
				>
					<div class="">
						<h2 class="typography-h2-md mb-[4rem] grid text-center">
			...
			<div id="help" data-section="help" class="section">
				<TwoColumnWithImage
					contents={{
						cardImage: '/images/DigitalDSA-executive-explains-loan-offers-on-video-call.jpg',
						cardAltName:
						...
						<ul class="list-disc space-y-4">
							...
							<li class="flex items-start gap-1">
								...
								<span>
									...
									your convenience factor, like document collection and processing from home.
								</span>
							</li>
						</ul>
					</div>
                ...
                <span class="font-semibold">💡Example:</span>`,
					...
					{:else if index == 2}
						<div id="how" class="bg-white text-black">
							...
							<div
								class="border-borderColor w-full border-b px-[0.5rem] py-[4rem] lg:px-[4rem] lg:py-0 lg:pt-[4rem] lg:pb-[8rem]"
							>
								<div class="">
