<script lang="ts">
  import HomeExpenses from "$lib/components/website/HomeExpenses.svelte";
  import IncomeComponent from "$lib/components/website/IncomeComponent.svelte";
  import LifeStyleExpenses from "$lib/components/website/LifeStyleExpenses.svelte";
  import Summary from "$lib/components/website/SummaryResult.svelte";
