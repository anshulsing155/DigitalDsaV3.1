    ...
    <div class="block lg:hidden">
      {#each content.mobileNavbarTitle as list, index (list)}
        ...
        >
          ...
          {#if index == 0}
            <div id="features" class="bg-[var(--landing-bg)] px-[0.5rem] pb-4 text-black dark:text-white">
              <TwoColumnWithLeftHeading contents={content.features} />
            </div>
          {:else if index == 1}
          ...
          {:else if index == 2}
            <div id="eligibility" class="bg-[var(--landing-bg)] px-[0.5rem] pb-4 text-black dark:text-white">
              <ButtonBanner contents={content.willApprove} />
              <AboveTitleWithTopIconCard contents={content.eligibility.contents} />
