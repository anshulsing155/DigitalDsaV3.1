<script>
	...
	// mobile-accordion
	let navBarMedium = ['Why the issue', 'Compare risks', 'Solutions', 'Tools & resources'];
	...
	<NewPageLayout {pageData}>
			...
			<div id="compare" data-section="compare" class="section">
				...
				>
					...
					<p class="typography-body-md mt-14 text-center text-[var(--form-text-secondary)]">
						💡 <span class="mr-2 font-semibold">Fun Fact :</span> Banks approve over 80% of loans for
						salaried professionals with stable income, but police and lawyers face higher scrutiny due
						to recovery risks.
					</p>
				</div>
					...
					>
						<div class="mt-4 text-center">
							<blockquote class="relative text-gray-800 italic">
								...
								I applied for a ₹5 lakh personal loan but got rejected twice. My salary had deductions,
								and my CIBIL score was average. With DigitalDSA’s help, I filed clean ITRs for two years
								and improved my score to 750. My third application was approved, and now I’m repaying
								comfortably!
					...
					>
						<div class="mt-4 text-center">
							<blockquote class="relative text-gray-800 italic">
								...
								As a lawyer, my income was mostly cash-based, and banks kept rejecting my loan applications.
								DigitalDSA guided me to document my income properly and maintain bank statements. I offered
								collateral for a business loan, and it was approved within weeks!
		...
		<div class="block lg:hidden">
			{#each navBarMedium as list, index}
				<details
					class="dropdown bg-darkColor col-span-3 text-white {index < list.length - 1
						? 'border-b'
						: ''}"
				>
					<summary
					...
					{#if index === 0}
						<div id="issue" data-section="issue" class="section bg-white text-black">
							<TwoColumnWithLeftHeading
								contents={{
									heading: 'Why Banks Say No?',
									listTopPara: `Let’s break down the real reasons banks hesitate:`,
					...
					{:else if index === 1}
						<div id="compare" data-section="compare" class="section bg-white text-black">
							<div
								class="w-full border-b border-[var(--form-border)] px-[0.5rem] py-[4rem] lg:px-[4rem] lg:py-0 lg:pt-[4rem] lg:pb-[8rem]"
							>
								<div class="">
								...
								<p class="typography-body-md mt-14 text-center text-[var(--form-text-secondary)]">
									💡 <span class="mr-2 font-semibold">Fun Fact :</span> Banks approve over 80% of loans
									for salaried professionals with stable income, but police and lawyers face higher scrutiny
									due to recovery risks.
								</p>
							</div>
							...
							<div class="mt-[4rem]">
								...
								>
									<div class="mt-4 md:text-center">
										<blockquote class="relative text-gray-800 italic">
											I applied for a ₹5 lakh personal loan but got rejected twice. My salary had
											deductions, and my CIBIL score was average. With DigitalDSA’s help, I filed
											clean ITRs for two years and improved my score to 750. My third application
											was approved, and now I’m repaying comfortably!
										</blockquote>
									</div>
								</TwoColumnWithImage>
								...
								>
									<div class="mt-4 md:text-center">
										<blockquote class="relative text-gray-800 italic">
											As a lawyer, my income was mostly cash-based, and banks kept rejecting my loan
											applications. DigitalDSA guided me to document my income properly and maintain
											bank statements. I offered collateral for a business loan, and it was approved
											within weeks!
										</blockquote>
										<p class="mt-10">
											<a
					...
					{:else if index === 2}
						<div id="solutions" class="section bg-white text-black" data-section="solutions">
							<TwoColumnWithLeftHeading
								contents={{
									heading: 'How to Improve Your Loan Chances',
									listTopPara: `Follow these steps to boost your eligibility:`,
					...
					{:else if index === 3}
						<div data-section="resources" id="resources" class="section bg-white text-black">
							<AboveTitleWithBlackCard
								contents={{
									heading: 'Loan Tools & Calculators',
									xlGridCol: 4,
		...
		>
			<p>
				Need help with your loan application? Message us anytime for expert guidance. Our team at
				DigitalDSA.com is ready to assist with documentation, eligibility, and finding the best loan
				options tailored to your needs. We’re here 24/7 to support you!
			</p>
		...
		<div slot="secondary" class="px-2">
			...
			<ThingsYouKnow contents={{ heading: `Things you should know` }}>
				<ul class="flex list-decimal flex-col gap-4 px-2 pl-4">
					<li>
						Banks view police and lawyers as high-risk due to recovery challenges, not because of
						their profession.
					</li>
					<li>
						Proper ITR filing and a strong CIBIL score can significantly improve loan approval
						chances.
					</li>
					<li>
						Cash-based income or salary deductions can complicate loan applications—document income
						clearly.
					</li>
					<li>Offering collateral can make banks more comfortable approving larger loans.</li>
					<li>
						Use DigitalDSA’s tools to assess eligibility and compare loan options before applying.
					</li>
					<li>
						Contact our specialists for personalized guidance to navigate loan challenges
						effectively.
					</li>
				</ul>
			</ThingsYouKnow>
